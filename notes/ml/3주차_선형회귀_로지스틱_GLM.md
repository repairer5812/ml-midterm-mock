...
> [참고]: $X, Y$ 사이의 관계를 예측하는 본질은 동일하나, $Y$값의 성질(연속 vs 이산)에 따라 회귀와 분류로 결정됩니다.
> 
...
> [참고]: Cost function이 2차 함수 같은 Analytic function이면, 미분값이 0인 점(기울기가 0인 평평한 바닥)을 찾아서 단번에 최적의 파라미터를 찾을 수 있습니다.
> 
